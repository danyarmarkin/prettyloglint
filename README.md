...
| Параметр                    | Описание                                                                     |
|-----------------------------|------------------------------------------------------------------------------|
| `allowed-punctuation`       | [Optional] Разрешенные знаки препинания в логах                              |
| `ignore-zap-fields`         | [Optional] Игнорировать ли поля zap в логах                                  |
| `custom-sensitive-patterns` | [Optional] Пользовательские шаблоны для поиска чувствительных данных в логах |
